...
const RESPONSE_CHANNEL_BY_OPERATION = Object.freeze({
  ...
  'market-offer-create': 'market-offer-create-response',
  'market-offer-accept': 'market-offer-accept-response',
  'item-list-by-owner': 'item-list-by-owner-response',
  'ship-list-by-npc-owner': 'ship-list-by-npc-owner-response',
  'ship-salvage-claim': 'ship-salvage-claim-response',
  'ship-piracy-seize': 'ship-piracy-seize-response',
