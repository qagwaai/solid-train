...
const RAW_MATERIALS = [
  {
    ...
    rarity: 'Common',
    material: 'Carbon',
    primaryUse: 'Structural frames, basic plating',
  ...
  },
  {
    ...
    rarity: 'Common',
    material: 'Copper',
    primaryUse: 'Power conduits, basic wiring',
    miningRequirement: 'Basic Mining Laser (Tier 1)',
  ...
  },
  {
    ...
    rarity: 'Common',
    material: 'Magnesium',
    primaryUse: 'Lightweight structural flares',
    miningRequirement: 'Basic Mining Laser (Tier 1)',
  ...
  },
  {
    ...
    rarity: 'Common',
    material: 'Nickel',
    primaryUse: 'Circuitry, low-tier drone shells',
    miningRequirement: 'Basic Mining Laser (Tier 1)',
  ...
  },
  {
    ...
    rarity: 'Uncommon',
    material: 'Lithium',
    primaryUse: 'High-density battery cells',
  ...
  },
  {
    ...
    rarity: 'Uncommon',
    material: 'Mercury',
    primaryUse: 'Ion engine propellant',
    miningRequirement: 'Pulse Drill (Tier 2)',
  ...
  },
  {
    ...
    rarity: 'Uncommon',
    material: 'Chromium',
    primaryUse: 'Anti-corrosive coatings',
    miningRequirement: 'Pulse Drill (Tier 2)',
  ...
  },
  {
    ...
    rarity: 'Uncommon',
    material: 'Tungsten',
    primaryUse: 'Heat-resistant plating',
  ...
  },
  {
    ...
    rarity: 'Uncommon',
    material: 'Titanium',
    primaryUse: 'Lightweight drone armor',
    miningRequirement: 'Pulse Drill (Tier 2)',
  ...
  },
  {
    ...
    rarity: 'Rare',
    material: 'Silver',
    primaryUse: 'Precision sensors, AI signals',
  ...
  },
  {
    ...
    rarity: 'Rare',
    material: 'Cobalt',
    primaryUse: 'Magnetic stabilizers, AI cores',
    miningRequirement: 'Thermal Beam (Tier 3)',
  ...
  },
  {
    ...
    rarity: 'Rare',
    material: 'Palladium',
    primaryUse: 'Fuel cells, catalyst systems',
    miningRequirement: 'Thermal Beam (Tier 3)',
  ...
  },
  {
    ...
    rarity: 'Rare',
    material: 'Uranium',
    primaryUse: 'Fission cores (mid-tier)',
  ...
  },
  {
    ...
    rarity: 'Exotic',
    material: 'Iridium',
    primaryUse: 'Extreme impact shielding',
  ...
  },
  {
    ...
    rarity: 'Exotic',
    material: 'Platinum',
    primaryUse: 'High-end conductors (Lvl 15+)',
    miningRequirement: 'Plasma Extractor (Tier 4)',
  ...
  },
  {
    ...
    rarity: 'Exotic',
    material: 'Rhodium',
    primaryUse: 'Reflective shielding / Stealth',
    miningRequirement: 'Plasma Extractor (Tier 4)',
  ...
  },
  {
    ...
    primaryUse: 'Ultimate-tier units',
...
const MARKET_CATALOG_BY_ID = new Map(MARKET_CATALOG.map((entry) => [entry.itemId, entry]));
