...
10. [M4 Descriptor Size and Payload Consistency Review Note](sw-13-m4-size-consistency-review-note.md)
11. [M4 Orion Decision Lock Note](sw-13-m4-orion-decision-lock-note.md)
...
- 2026-05-30: Added M4 descriptor size and payload consistency review note; marked M4 Forge scope complete with Nova evidence pending.
- 2026-05-30: Added M4 Orion decision lock note and linked required guardrail, threshold, and parity enforcement points.
