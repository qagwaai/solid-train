...
test('normalizeCharacter computes credits from puts only', () => {
  ...
  const character = context.normalizeCharacter({
    ...
    createdAt: '2026-05-05T00:00:00.000Z',
    creditLedger: [
      { type: 'put', amount: 425, description: 'Starting credits', timestamp: '2026-05-05T00:00:00.000Z', referenceId: null },
      { type: 'put', amount: 500, description: 'Mission reward', timestamp: '2026-05-05T01:00:00.000Z', referenceId: 'm-01' }
    ]
  });
...
test('normalizeCharacter subtracts takes from puts', () => {
  ...
  const character = context.normalizeCharacter({
    ...
    creditLedger: [
      { type: 'put', amount: 425, description: 'Starting credits', timestamp: '2026-05-05T00:00:00.000Z', referenceId: null },
      { type: 'take', amount: 100, description: 'Market purchase', timestamp: '2026-05-05T02:00:00.000Z', referenceId: 'item-42' }
    ]
  });
...
test('normalizeCharacter handles mixed puts and takes across multiple entries', () => {
  ...
  const character = context.normalizeCharacter({
    ...
    creditLedger: [
      { type: 'put', amount: 425, description: 'Starting credits', timestamp: '2026-05-05T00:00:00.000Z', referenceId: null },
      { type: 'put', amount: 500, description: 'Mission reward', timestamp: '2026-05-05T01:00:00.000Z', referenceId: 'm-01' },
      { type: 'take', amount: 200, description: 'Fuel purchase', timestamp: '2026-05-05T02:00:00.000Z', referenceId: null },
      { type: 'take', amount: 75, description: 'Dock fee', timestamp: '2026-05-05T03:00:00.000Z', referenceId: null }
    ]
  });
